...
class Analysis {
    ...
    init() {
        ...
        // $('#versions_all')[0].onclick = versions_select_all
...
//     request('/analysis/plots', data, function (response) {
//         // TODO: NOT VERY SMART
...
//     let versions = $.map($('input.versions:checked'), s => s.id)
//     let data = {
//         'documents': documents,
//     }
//     return data
...
// const versions_select_all = function () {
//     $('input.versions').each(select_all)
// }
